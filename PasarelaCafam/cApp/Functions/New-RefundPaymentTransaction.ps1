function New-RefundPaymentTransaction {
    ...
    .DESCRIPTION
        Ejecuta el procedimiento que genera las compras, para luego anularlas.Retorna la informaci�n de las transacciones de anulacion en un array.
    .PARAMETER Token
        String con token de autenticaci�n
    .PARAMETER PaymentTest
        Prueba de la cual se desea generar datos. Revisar funci�n New-PaymentTransaction.
    .EXAMPLE
