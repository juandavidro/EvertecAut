Function Get-Report {
    ...
    $PageReport.Name | ForEach-Object {
        ...
        $Archivo = $Archivo.Replace("<link href='https://fonts.googleapis.com/css?family=Open+Sans:400,600' rel='stylesheet' type='text/css'>", "<link href='styles.css' rel='stylesheet' type='text/css'>")
        ...
        $Archivo = $Archivo.Replace("Executive Summary", "Resumen Ejecutivo")
        $Archivo = $Archivo.Replace("TestRunner", "Tester")
